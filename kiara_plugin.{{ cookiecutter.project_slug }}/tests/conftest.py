...
from kiara.utils.testing import list_job_descs, get_tests_for_job
...
def example_job_test(request, kiara_api) -> JobTest:
    ...
    tests = get_tests_for_job(job_alias=job_desc.job_alias, job_tests_folder=job_tests_folder)
